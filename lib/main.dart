...
import 'package:your_cart/Screen/Product_Description_Page.dart/ProductDetailed_Page.dart';
...
import 'Screen/Authentication_Pages/Registration.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "product_des1": (context) => const Product_Description(),
      },
    );
  }
}
